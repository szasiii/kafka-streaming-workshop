...
public class Ex3Consumer {
    public static void main(String[] args) throws Exception {
        Consumer<String, String> consumer = createConsumer(Arrays.asList("ex3-inner-join-output", "ex3-left-join-output"), StringSerializer.class.getName(), StringDeserializer.class.getName());
