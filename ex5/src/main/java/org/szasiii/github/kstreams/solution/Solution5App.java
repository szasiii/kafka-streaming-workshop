...
public class Solution5App implements TopologyProvider {

    public static void main(String[] args) throws Exception {
        Solution5App solution5App = new Solution5App();
        ...
        final KafkaStreams kafkaStreams = new KafkaStreams(solution5App.createTopology(), config);
        kafkaStreams.start();
